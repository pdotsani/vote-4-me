...
describe('Poll API:', function () {
  ...
  describe('GET /api/polls', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2['default'])(app).get('/api/polls').expect(200).expect('Content-Type', /json/).end(function (err, res) {
        if (err) {
          return done(err);
        }
        polls = res.body;
  ...
  describe('POST /api/polls', function () {
    beforeEach(function (done) {
      (0, _supertest2['default'])(app).post('/api/polls').send({
        name: 'New Poll',
  ...
  describe('GET /api/polls/:id', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2['default'])(app).get('/api/polls/' + newPoll._id).expect(200).expect('Content-Type', /json/).end(function (err, res) {
        if (err) {
          return done(err);
        }
        poll = res.body;
  ...
  describe('PUT /api/polls/:id', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2['default'])(app).put('/api/polls/' + newPoll._id).send({
        name: 'Updated Poll',
  ...
  describe('DELETE /api/polls/:id', function () {
    ...
    it('should respond with 204 on successful removal', function (done) {
      (0, _supertest2['default'])(app)['delete']('/api/polls/' + newPoll._id).expect(204).end(function (err, res) {
        if (err) {
          return done(err);
        }
        done();
    ...
    it('should respond with 404 when poll does not exist', function (done) {
      (0, _supertest2['default'])(app)['delete']('/api/polls/' + newPoll._id).expect(404).end(function (err, res) {
        if (err) {
          return done(err);
        }
        done();
...
//# sourceMappingURL=poll.integration.js.map
